...
const searchController = async function() {
    try {
        ...
        const data = _modelJs.paginationLogic(2);
        console.log(data);
        _resultsViewJsDefault.default.render(data);
        _paginationViewJsDefault.default.render(_modelJs.state.search.page);
    } catch (er) {
        throw er;
    }
};
...
},{"./model.js":"Y4A21","./views/recipeView.js":"l60JC","./views/searchView.js":"9OQAM","./views/resultsView.js":"cSbZE","lodash":"3qBDj","./views/paginationView.js":"6z7bi","regenerator-runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"Y4A21":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const searchResults = async function(searchKey) {
    try {
        const data = await _helperJs.getJSON(_configJs.API_URL + `?search=${searchKey}`);
        console.log(data);
...
var _iconsSvg = require("../../img/icons.svg"); // Parcel1 parcelning 1-usuli
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
// import icons from "url:../img/icons.svg" // Parcel2 parcelning 2-usulu
class RecipeView {
    #errorMessage = 'Siz qidirayotgan malumot tpilmadi. Iltimos qayta urinib koring!';
...
},{"../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3qBDj":[function(require,module,exports) {
